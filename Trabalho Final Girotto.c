	...
	while((continuar_jogo1 == 0) && (continuar_jogo2 == 0) && (continuar_jogo3 == 0))
	{
		...
		case (2):
			...
			while(continuar_jogo2 == 1)
			{
				...
				printf ("\nSEJA BEM VINDO\n");
				printf ("---------------------------------------------------------------------------------\n");
				printf ("Cobra na Caixa: Jogo em dupla que usa da sorte para esconder uma cobra e um botão\n");
				printf ("entre 5 caixas, o primeiro que achar o botão ganha. Mas cuidado, se você achar a\n");
				printf ("cobra perde automaticamente. Se divirta!\n\n");
				printf ("---------------------------------------------------------------------------------\n");
				printf ("bom jogo\n\n");
		...
		case(3):
			...
			while(continuar_jogo3 == 1)
			{
				...
				printf ("\nSEJA BEM VINDO");
				printf ("-----------------------------------------------------------------------------------\n");
				printf ("Gousmas War:  O jogo é multiplayer e possui dois jogadores, que iniciam com duas\n");
				printf ("Gousmas cada. O computador escolhe aleatoriamente qual jogador começa. Seu objetivo\n");
				printf ("é acabar com todas as Gousmas do outro jogador usando estratégia e\n");
				printf ("matemática. O jogador que perder todas as suas Gousmas é o perdedor.\n\n");
						...
						while((turno2 == 1) && (fim3 == 0))  // começo turno 2 caso nome 2 comece
						{
							...
							else    //escolheu dividir
							{
								...
								if((furiaj1_1 > 0) && (furiaj1_2 == 0 ))
								{
									...
									{
										system ("cls || clear");
										printf("escolha inválida, você não pode passar uma quantidade de fúria que faça a sua gousma atual ou a nova ficarem com menos de 1 de fúria\n");
										printf("Suas Gousmas:\n");
										printf("\t Fúria gousma 1: %d\n", furiaj1_1);
										printf("\t Fúria gousma 2: %d\n", furiaj1_2);
										printf("Gousmas de %s:\n", nome_2);
										printf("\t Fúria gousma 1: %d\n", furiaj2_1);
										printf("\t Fúria gousma 2: %d\n", furiaj2_2);
										printf("Quanto de fúria você deseja passar para a nova gousma?\n");
										printf("R: ");
										scanf("%d", &quantDividir1);
									...
									furiaj1_2 = furiaj1_2 + quantDividir1;
									furiaj1_1 = furiaj1_1 - quantDividir1;
									printf("Os novos valores de fúria das suas gousmas são:\n");
									printf("\t Fúria gousma 1: %d\n", furiaj1_1);
									printf("\t Fúria gousma 2: %d\n", furiaj1_2);
									turno1 = 1;
									turno2 = 0;
								...
								else if((furiaj1_1 == 0) && (furiaj1_2 > 0 ))
								{
									...
									while(((furiaj1_2 - quantDividir1) < 1) || ((furiaj1_2 - quantDividir1) > 4))
									{
										...
										printf("\t Fúria gousma 1: %d\n", furiaj2_1);
										printf("\t Fúria gousma 2: %d\n", furiaj2_2);
										printf("Quanto de fúria voce deseja passar para a nova gousma?\n");
										printf("R: ");
										scanf("%d", &quantDividir1);
									...
									furiaj1_1 = furiaj1_1 + quantDividir1;
									furiaj1_2 = furiaj1_2 - quantDividir1;
									printf("\nOs novos valores de fúria das suas gousmas são:\n");
									printf("\t Furia gousma 1: %d\n", furiaj1_1);
									printf("\t Furia gousma 2: %d\n", furiaj1_2);
									turno1 = 1;
									turno2 = 0;
